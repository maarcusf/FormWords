...
public class TelaAjuda1EUA extends AGScene
{
    ...
    public TelaAjuda1EUA(AGGameManager pManager) {
        super(pManager);
    }
    ...
    public void init()
    {
        ...
        fundoSobre = createSprite(R.drawable.telahelp,1,1);
    ...
    public void loop()
    {
        ...
        {    // ao clicar na tela dispara o som carregado anteriormente
            ...
            {
                vrGameManager.setCurrentScene(10); //arrumar aqui
                return;
            }
